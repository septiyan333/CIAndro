...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
      <a class="navbar-brand" href="<?= base_url('Kurir'); ?>"><?php echo 'Selamat datang, ' . $akun['nama_lengkap']; ?></a>
        ...
        <div class="navbar-nav ml-auto">
          ...
          <div class="btn-group">
            ...
            <div class="dropdown-menu">
              ...
              <a class="dropdown-item" href="<?php echo base_url('Kurir/tukar_poin'); ?>">Tukar Poin</a>
      ...
      <div class="col-6 info-panel">
        <div class="row isi">
          <div class="col-lg">
            ...
            <a class="nav-item btn btn-primary" href="<?php echo base_url('Kurir/penjemputan'); ?>"><span>Penjemputan</span></a>
          </div>
