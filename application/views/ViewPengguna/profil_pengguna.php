  ...
  <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #67A567;">
    <div class="container">
      <a class="navbar-brand txtputih" href="<?php echo base_url('Pengguna/profil'); ?>">PROFIL</a>
    ...
    <div class="row">
      ...
      <div class="col-lg">
        ...
        <div class="row align-items-center" style="padding: 20px;">
          ...
          <div class="col">
            <a class="btn btn-success" href="<?php echo base_url('Pengguna/ubah_profil'); ?>" width="300px"><span>Ubah Profil</span></a>
          </div>
        </div>
